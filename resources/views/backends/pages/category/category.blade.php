...
@section('title')
<title>Category Lists :: Newscripts</title>
@endsection
            ...
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">                        
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ __('Category Lists') }}</li>
                    </ul>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeA">
                                        ...
                                        <td class="actions" style="width: 15%">
                                            <p class="demo-button">
                                                <a href="{{ route('edit.category',$item->id) }}" class="btn btn-default" title="view"><span class="sr-only">view</span> <i class="fa fa-files-o"></i></a>
                                                ...
                                                <a href="{{ route('edit.category',$item->id) }}" class="btn btn-success" title="edit"><span class="sr-only">edit</span> <i class="fa fa-edit"></i></a>
                                                <a href="{{ route('delete.category',$item->id) }}" class="btn btn-danger" title="Delete"><span class="sr-only">Delete</span> <i class="fa fa-trash-o"></i></a>
                                            </p>
                                        </td>
                                    </tr>
