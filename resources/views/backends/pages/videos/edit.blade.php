...
@section('title')
<title>Modify Video :: Newscripts</title>
@endsection
    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">                        
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Videos</h2>
                    <ul class="breadcrumb">
                ...
                <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                    <div class="inlineblock text-center m-r-15 m-l-15 hidden-sm">
                        <a href="{{ route('videos') }}" class="btn btn-warning">Back Videos</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    <div class="body">
                        <form id="basic-form" method="POST" action="{{ route('edit.video',$getData->id) }}" enctype="multipart/form-data">
                            @csrf
                            {{-- headline --}}
