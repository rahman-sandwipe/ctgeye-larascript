...
@section('title')
<title>{{ __('Insert News :: Newscripts') }}</title>
@endsection
    ...
    <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                    <div class="inlineblock text-center m-r-15 m-l-15 hidden-sm">
                        <a href="{{ route('news') }}" class="btn btn-warning">{{ __('Back News') }}</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    <div class="body">
                        <form id="basic-form" method="POST" action="{{ route('create.news') }}" enctype="multipart/form-data">
                            @csrf
                            {{-- headline --}}
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="content">News Content<sup class="text-danger">*</sup></label>
