...
@section('title')
<title>{{ __('Insert Subcategory :: Newscripts') }}</title>
@endsection
    ...
    <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                    <div class="inlineblock text-center m-r-15 m-l-15 hidden-sm">
                        <a href="{{ route('subcategory') }}" class="btn btn-warning">{{ __('Back Category') }}</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h2 class="text-center">Insert New Sub Category</h2>
                    </div>
                    <div class="body">
                        <form id="basic-form" method="post" action="{{ route('create.subcategory') }}">@csrf
